...
This helper supports the generate-image skill's transparent-background fallback:
generate an image on a flat chroma-key color, then convert that key color to alpha.
"""
